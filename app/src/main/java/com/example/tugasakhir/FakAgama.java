...
public class FakAgama extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fak_agama);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (jawaban1.getText().toString().toLowerCase().equals("eksya")) {
                    value = value + 20;
                }
                if (jawaban2.getText().toString().toLowerCase().equals("bahasa arab")) {
                    value = value + 20;
                }
                if (jawaban3.getText().toString().toLowerCase().equals("1963 - 1964")) {
                    value = value + 20;
                }
                if (jawaban4.getText().toString().toLowerCase().equals("muhammad samsudin")) {
                    value = value + 20;
                }
                if (jawaban5.getText().toString().toLowerCase().equals("ar fakhruddin")) {
                    value = value + 20;
                }


                Intent inten = new Intent(FakAgama.this, HasilActivity.class);
