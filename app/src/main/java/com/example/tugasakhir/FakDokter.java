...
public class FakDokter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fak_dokter);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (jawaban1.getText().toString().toLowerCase().equals("2010")) {
                    value = value + 20;
                }
                if (jawaban2.getText().toString().toLowerCase().equals("pimpinan pusat muhammadiyah 1993")) {
                    value = value + 20;
                }
                if (jawaban3.getText().toString().toLowerCase().equals("kebidanan")) {
                    value = value + 20;
                }
                if (jawaban4.getText().toString().toLowerCase().equals("sri sundari")) {
                    value = value + 20;
                }
                if (jawaban5.getText().toString().toLowerCase().equals("jl. hos cokroaminoto")) {
                    value = value + 20;
                }


                Intent inten = new Intent(FakDokter.this, HasilActivity.class);
